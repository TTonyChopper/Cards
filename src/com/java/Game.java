...
{ 
	...
	public Game()
	{
		...
		System.out.println("Donner une position entre 1 et 52 : une carte sera retir�e.");
		waiting();
		...
		System.out.println("Votre main de d�part :");
	...
	public void askToPickCard(int playernumber)
	{
		...
		newcard.printCardfr();
		if(!((hands.get(0)).isDouble())) System.out.println("Pas de chance : pas de nouvelle paire cr��e...");
		System.out.print("");
		pause();
		pause();
	}
	...
	{
		System.out.println("Voulez-vous m�langez votre main[syst�me anti-triche :)] ?[Y/N]");
		waiting();
		boolean ok = false;
		do
		{
		...
		{
			System.out.println("De toute fa�on je vois tes cartes...");
			pause();
		}
	}
	public void shufflePlayer()
	{
		if ((answer.equals("Y"))||(answer.equals("y")))
		{
			...
			System.out.println("com.java.Main m�lang�e :");
	...
	public boolean playTurn()
	{
		...
		{
			System.out.println("Vous �tes qualifi� !");
			qualify(1);
			if (playersPlaying==1) return false;
		}  
		////Qualifier les ordinateurs ?
	...
	public void stats()
	{
		...
		{
			System.out.println("Vous avez gagn� au bout de "+turnPlayed.get(0)+" tours !");
			pause();
		}
		for (int i=1;i<nbPlayers;i++)
		{
			...
			{
				System.out.println((hands.get(i)).getNameCPU()+" ("+(i+1)+") a gagn� au bout de "+turnPlayed.get(i)+" tours !");
				pause();
			}
		}
		if (nloser==-1) 
		{
			System.out.println("Vous avez perdu...au "+turn+"i�me tour !");
			pause();
			System.out.println("Vous aviez la carte : ");
			(hands.get(0)).printCardfr(0);
			pause();
			System.out.print("La carte que vous aviez retir�e �tait : ");
			pause();
			removed.printCardfr();
		}
